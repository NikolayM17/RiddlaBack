...
namespace Service.Implementations
{
		...
		where T : BaseEntity
	{
		...
		public async Task<BaseResponse<T>> AddEntityAsync(T entity)
		{
			...
			catch (Exception ex)
			{
				return new BaseResponse<T>
				{
					...
					StatusCode = Riddla.Domain.Enums.StatusCode.InternalServerError,
					Data = entity
				};
			}
		}
		...
		public BaseResponse<T> GetEntity(T entity)
		{
			try
			{
		...
		public async Task FillPrimaryDataAsync()
		{
			await _repository.FillPrimaryDataAsync();
		}
